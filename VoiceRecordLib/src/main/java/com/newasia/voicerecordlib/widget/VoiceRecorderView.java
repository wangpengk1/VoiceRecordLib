 ...
 */
package com.newasia.voicerecordlib.widget;
...
import com.newasia.voicerecordlib.R;
import com.newasia.voicerecordlib.core.VoiceRecorder;
import com.newasia.voicerecordlib.serivice.PlayService;
import com.newasia.voicerecordlib.utils.CommonUtils;
import com.newasia.voicerecordlib.utils.EMError;
import com.newasia.voicerecordlib.utils.PathUtil;
...
public class VoiceRecorderView extends RelativeLayout {
    ...
    protected EaseVoiceRecorderCallback mListener;
    ...
    public void setVoiceRecorderCallBack(EaseVoiceRecorderCallback callBack)
    {
        mListener = callBack;
    }
    ...
    private void bindService(Context context)
    {
        ...
        PlayServiceConnection ServiceCon = new PlayServiceConnection();
    ...
    private void init(Context context) {
        ...
        move_up_to_cancel = context.getString(R.string.finger_up_to_cancel);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (event.getY() < 0) {
                    ...
                    try {
                        ...
                        if (length > 0) {
                            if (mListener != null) {
                                mListener.onVoiceRecordComplete(getVoiceFilePath(), length);
                            }

                        } else if (length == EMError.FILE_INVALID) {
                            XToastUtil.error(R.string.Recording_without_permission);
                        } else {
                            XToastUtil.error(R.string.The_recording_time_is_too_short);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    public void startRecording() {
        if (!CommonUtils.isSdcardExist()) {
            XToastUtil.warning(R.string.Send_voice_need_sdcard_support);
            return;
        }
        try {
            wakeLock.acquire();
            this.setVisibility(View.VISIBLE);
            recordingHint.setText(context.getString(R.string.finger_up_to_cancel));
            ...
            XToastUtil.error(R.string.recoding_fail);
            return;
        }
    }
    ...
    public void playVoiceFile(ImageView imageView,String path)
    {
